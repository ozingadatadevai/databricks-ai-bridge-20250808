...
# -*- coding: utf-8 -*-
#
# Databricks AI Bridge documentation build configuration file, created by
...
version = importlib.metadata.version("databricks_ai_bridge")
...
# html_title = 'Databricks AI Bridge v0.0.1'
...
# of the sidebar.
html_logo = "./_static/logo/databricks-logo.svg"
html_style = "css/sphinx_rtd_theme-tweaks.css"
...
htmlhelp_basename = "DatabricksAIBridgeDoc"
...
latex_documents = [
    (
        master_doc,
        "DatabricksAIBridge.tex",
        "DatabricksAIBridge Documentation",
        "Databricks",
        "manual",
    ),
]
...
man_pages = [(master_doc, "DatabricksAIBridge", "DatabricksAIBridge Documentation", [author], 1)]
...
nitpicky = True
nitpick_ignore = [
    # Ignore "parent class reference not found" errors for
